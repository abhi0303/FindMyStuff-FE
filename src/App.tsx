...
const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      ...
      // genuinely final.
      retry: false,
      // Offline mode reads from IndexedDB, which has to run even when the browser says
      // there's no network. Live requests then fail fast instead of pausing silently,
      // which is also what lets the app offer offline mode.
      networkMode: 'always',
    },
